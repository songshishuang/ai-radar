...
{{"headline": "<中文标题，不超过30字>",
 "so_what": "<一句话结论：这件事对 PM 最重要的含义是什么，不超过40字，直击要害>",
...
REQUIRED_KEYS = {"headline", "so_what", "background", "industry_impact", "competitive", "rd_efficiency", "biz_opportunity", "action_items"}
