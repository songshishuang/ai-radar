...
SEED_SOURCES: list[dict] = [
    ...
    {"category": "vendor", "name": "Anthropic News", "fetch_method": "rss", "url": "https://www.anthropic.com/rss.xml"},
    ...
    {"category": "vendor", "name": "Meta AI Blog", "fetch_method": "rss", "url": "https://ai.meta.com/blog/rss/"},
    {"category": "vendor", "name": "Microsoft AI", "fetch_method": "rss", "url": "https://blogs.microsoft.com/ai/feed/"},
    {"category": "vendor", "name": "HuggingFace Blog", "fetch_method": "rss", "url": "https://huggingface.co/blog/feed.xml"},
    {"category": "vendor", "name": "Mistral News", "fetch_method": "rss", "url": "https://mistral.ai/feed.xml"},
    # ── 产研 AI 范式 ──
    ...
    {"category": "community", "name": "r/LocalLLaMA", "fetch_method": "reddit", "url": "https://www.reddit.com/r/LocalLLaMA/top.json?t=day&limit=25"},
    {"category": "community", "name": "r/MachineLearning", "fetch_method": "reddit", "url": "https://www.reddit.com/r/MachineLearning/top.json?t=day&limit=25"},
    # ── 行业媒体 / Newsletter ──
    ...
    {"category": "media", "name": "Ben's Bites", "fetch_method": "rss", "url": "https://bensbites.beehiiv.com/feed"},
